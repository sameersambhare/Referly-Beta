              ...
              <div className="pt-4">
                <div className="bg-muted p-4 rounded-lg">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="text-sm font-medium">Join the Program</h4>
                      <p className="text-xs text-muted-foreground mt-1">
                        After completing a task, you can join the referral program yourself and earn rewards by inviting others.
                      </p>
                    </div>
                  </div>
                </div>
